...
> 历史归档（2026-09-21 版本）：旧文中的“三个坑恰好 3 张”“必须有教学图”“虚构实战案例”与现行规范不符，不再作为新课题范本。请以 [全站教学方法](../../design-system/PEDAGOGY.md)、[设计系统](../../design-system/DESIGN-SYSTEM.md)、[课题规格](TOPIC.md)和 `tools/check_handbook.py` 为准；本文件只用于理解早期设计来历。
